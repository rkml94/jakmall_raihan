...
.btn:focus {
  -webkit-box-shadow: 0 0 0 0.2rem rgba(30, 144, 255, 0.5);
...
.btn--success:focus {
  -webkit-box-shadow: 0 0 0 0.2rem rgba(154, 205, 50, 0.5);
...
.btn--grey-light--outline:hover, .btn--grey-light--outline:focus {
  background-color: #F2F2F2;
  color: white;
}

.btn--grey-light--outline:focus {
  -webkit-box-shadow: 0 0 0 0.2rem rgba(242, 242, 242, 0.5);
          box-shadow: 0 0 0 0.2rem rgba(242, 242, 242, 0.5);
}
